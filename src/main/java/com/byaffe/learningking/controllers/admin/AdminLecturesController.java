...
import com.byaffe.learningking.services.QuizLectureMappingRequestDTO;
...
public class AdminLecturesController {
    ...
    @PostMapping("/attach-quiz")
    public ResponseEntity<BaseResponse> attachQuize(@RequestBody QuizLectureMappingRequestDTO dto) throws JSONException {
        SessionContext.permissionProtection(PermissionConstant.Course_Create);
        quizLectureMappingService.save(dto);
        return ResponseEntity.ok().body(new BaseResponse(true));
    }
