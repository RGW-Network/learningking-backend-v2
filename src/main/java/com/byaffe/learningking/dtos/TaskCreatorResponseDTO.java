...
@Builder
@AllArgsConstructor
public class TaskCreatorResponseDTO extends BaseDTO {
private Long id;
    ...
    public static TaskCreatorResponseDTO fromDBModel(TaskDoer dbModel){
        TaskCreatorResponseDTO dto=new TaskCreatorResponseDTO();
