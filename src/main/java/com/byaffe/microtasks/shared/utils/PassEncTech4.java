...
import com.byaffe.microtasks.config.EnvironmentConstants;
...
public class PassEncTech4
{
    ...
    {  
        ...
        byte[] securePassword = hash(password.toCharArray(), getSaltvalue().getBytes());
    ...
    public static String generateOTP(int length) {
        // Define the possible characters in the OTP
        ...
        // Generate OTP using random characters
