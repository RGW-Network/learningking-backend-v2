...
const Documentation = () => {
    return (
        <div className="card docs">
            ...
            <p>
                Next step is running the application using the start script and navigate to <b>http://localhost:3000/</b> to view the application. That is it, you may now start with the development of your application using the Ultima template.
            </p>
...
"primeicons": "^6.0.1",                    //required: Icons                    `}
            ...
            <p>
                ...
                under the app folder; <span className="text-primary font-medium">{`(main)`}</span> represents the pages that reside in the main dashboard layout, <span className="text-primary font-medium">{`(full-page)`}</span> groups the pages with
                full page content such as landing page or a login page and <span className="text-primary font-medium">{`(landing)`}</span> is the full page layout that is only available for the dark color scheme.
            </p>
...
`}
            ...
            <p>
                Landing page is required to be defined under the <span className="text-primary font-medium">app/{'(landing)'}/</span> folder since it is only available for the dark color scheme. This page uses the{' '}
                <span className="text-primary font-medium">app/{'(landing)'}/layout.tsx</span> as the root layout.
            </p>
            <pre className="app-code">
                <code>
                    {`import { Metadata } from "next";
