...
import LookupFormDialogView from './CategoryFormDialog';
    ...
    return (
        <div className="grid">
            <div className="col-12 flex justify-content-end flex-wrap">
                <Button label={'Create category'} icon={PrimeIcons.PLUS} className="p-button-secondary" onClick={openNewFormDialog} />
            </div>
            ...
            <div className="col-12">
                <div className="card">
                    <DataTable value={records} paginator={false} className="datatable-responsive" paginatorPosition="both" emptyMessage="No record found." loading={isLoading}>
                        ...
                        <Column field="academy" header={'Parent'}></Column>
